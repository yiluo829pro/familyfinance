...
export function Sidebar({ open, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed top-0 left-0 h-full w-64 bg-slate-900 flex flex-col z-30 transition-transform duration-300',
      ...
      >
        ...
        <div className="px-6 py-5 border-b border-slate-800">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="text-sm font-bold text-white">FamilyFi</p>
        ...
        <div className="px-6 py-4 border-t border-slate-800">
          ...
          <p className={cn('text-lg font-bold', netWorth >= 0 ? 'text-emerald-400' : 'text-rose-400')}>
